 ...
 * inserted.
 *
 * Additionally, this program prompts the user for their name and sends it to the server
 *
 */
...
public class JClient
{
	public static void main(String[] args)
	{
		...
		System.out.print("Before connecting, please enter your name: ");
		...
		try
		{
			...
			serverOutput.writeBytes("HELO " + name + "\n");
